...
st.set_page_config(page_title='Penguin Data', page_icon="🐧", layout="centered")
...
bl = st.sidebar.slider(
    "Bill Length (mm)",
    float(meta["bill_length_mm"][0]),    # min
    float(meta["bill_length_mm"][1]),    # max
    float(meta["bill_lenght_default"]),  # default
    step=1.0
)
