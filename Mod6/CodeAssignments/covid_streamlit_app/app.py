...
st.set_page_config(page_title= "Covid data", page_icon="🦠", layout="centered")
...
# === CONFIG ===
DATA_PATH = "/Users/ayemaq/Desktop/marcy_lab/DA2025_Lectures/Mod6/CodeAssignments/covid_streamlit_app/data/covid copy.csv"
